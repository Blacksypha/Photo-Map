...
1. I'd like for the camera button to not be as invasive, more discreet is better
2. I would change my starting location to Baltimore

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/E8QHsuk.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

I was having a lot of trouble getting the camera to look like the one in the assignment. Mine is a but cut off.
